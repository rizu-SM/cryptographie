...
const ALGORITHMS = {
  ...
  asymetrique: [
    { id: "rsa", name: "RSA", sub: "Clé publique", color: "#facc15", keyFields: [{ id: "n", label: "Modulus n", placeholder: "ex: 3233", hint: "Bientôt disponible" }, { id: "e", label: "Exposant e", placeholder: "ex: 17", hint: "" }], comingSoon: true },
    { id: "elgamal", name: "ElGamal", sub: "Logarithme discret", color: "#fb923c", keyFields: [{ id: "p", label: "Premier p", placeholder: "ex: 23", hint: "" }, { id: "g", label: "Générateur g", placeholder: "ex: 5", hint: "" }, { id: "x", label: "Clé privée x", placeholder: "ex: 6", hint: "" }], comingSoon: true },
  ],
};

const GROUP_LABELS = { classique: "CRYPTO CLASSIQUE", symetrique: "CRYPTO SYMÉTRIQUE", asymetrique: "CRYPTO ASYMÉTRIQUE" };
